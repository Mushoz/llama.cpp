...
static void ggml_cuda_mul_mat(ggml_backend_cuda_context & ctx, const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst) {
    ...
    bool use_mul_mat_vec   = src1->type == GGML_TYPE_F32
    ...
    printf("use_mul_mat_vec: %d\n", use_mul_mat_vec);
    printf("use_mul_mat_vec_q: %d\n", use_mul_mat_vec_q);
    printf("use_mul_mat_q: %d\n", use_mul_mat_q);
    ...
    printf("any_gpus_with_slow_fp16: %d\n", any_gpus_with_slow_fp16);
    printf("any_gpus_without_fp16_mma: %d\n", any_gpus_without_fp16_mma);
